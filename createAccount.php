                            ...
                            <div class="col-lg-4 col-md-6 tm-contact-form-input">
                                ...
                                <div class="form-group">
                                    <select id="user_depart" class="form-control">
                                        ...
                                        <option value="Jenetorial">Jenetorial</option>
                                ...
                                <div class="form-group">
                                    <button class="tm-submit-btn1" onclick="save_inv();" type="submit" name="submit">Create</button> 

                                </div>  
                                <a href="login.php" style="margin-right:300px;">Cancel</a>
                            </div>
