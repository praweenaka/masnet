                ...
                <ul class="slides">
                    <li>
                        <div class="tm-banner-inner">
                            <h1 class="tm-banner-title">JENI<span class="tm-yellow-text">TORIAL</span> </h1>
                            <!--<p class="tm-banner-subtitle">For Upcoming Holidays</p>-->

                        </div>
                        <img src="img/jeni.jpg" alt="Banner 3" />
                    </li>
                </ul>
            </div>
        </section>
                    ...
                    <ul class="slides1">
                        <li>
                            ...
                            <div class="form-group">
                                ...
                                $sql = "select * from user_mast where user_name='" . $_SESSION['UserName'] . "' and user_depart='Jenetorial'";
                                ...
                                <?php
                                include './connectioni.php';
                                $sql = "select * from user_mast where user_name='" . $_SESSION['UserName'] . "' and (user_depart='Canteen' or user_depart='Transport' or user_depart='Security')";
                                $result = mysqli_query($GLOBALS['dbinv'], $sql);
