            ...
            <div class="flexslider flexslider-banner">
                <ul class="slides">
                    <li>
                        ...
                        <img src="img/MAS-Holdings-2.jpg" alt="Banner 3" />	
                    </li>		    
                </ul>
            </div>	
        </section>
                    ...
                    <ul class="slides">
                        <li>
                            ...
                            <div class="contact-text">
                                ...
                                <p class="slider-description">10th Floor,<br>
                                    Aitken Spence Tower 2,<br>
                                    315, Vauxhall Street,<br>
                                    Colombo 02,<br>
                                    Sri Lanka.<br>
                                    TP : (+94) 11 4796444<br>
                                    Email : info@masholdings.com.</p>
