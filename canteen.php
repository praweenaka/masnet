                ...
                <ul class="slides">
                    <li>
                        <div class="tm-banner-inner">
                            <h1 class="tm-banner-title">CAN<span class="tm-yellow-text">TEEN</span> </h1>
                            <!--<p class="tm-banner-subtitle">For Upcoming Holidays</p>-->

                        </div>
                        <img src="img/getImage.gif" alt="Banner 3" />
                    </li>
                </ul>
            </div>
        </section>
                    ...
                    <ul class="slides1">
                        <li>
                            ...
                            <div class="form-group">
                                ...
                                $sql = "select * from user_mast where user_name='" . $_SESSION['UserName'] . "' and user_depart='Canteen'";
                                ...
                                <?php
                                include './connectioni.php';
                                $sql = "select * from user_mast where user_name='" . $_SESSION['UserName'] . "' and (user_depart='Jenetorial' or user_depart='Transport' or user_depart='Security')";
                                $result = mysqli_query($GLOBALS['dbinv'], $sql);
                                ...
                                <?php
                                include './connectioni.php';
                                $sql = "select * from user_mast where user_name='" . $_SESSION['UserName'] . "' and (user_depart='Jenetorial' or user_depart='Transport' or user_depart='Security' or user_depart='Canteen')";
                                $result = mysqli_query($GLOBALS['dbinv'], $sql);

                                while ($row = mysqli_fetch_array($result)) {
                                    echo" <div class = \"row\">";
                                    echo" <label class = \"col-sm-1\"></label>";
                                    echo"</div>";
                                    echo"<div class = \"row\">";
                                    echo"<div id = \"comments\"class =\"col-md-6 scroll\">";

                                    echo"  </div>";


                                    echo" <div id = \"filebox\" class = \"col-md-6 scroll\">";
