                ...
                <ul class="slides">
                    <li>
                        <div class="tm-banner-inner">
                            ...
                            <h1 class="tm-banner-title">USER <span class="tm-yellow-text">PERMISSION</span> </h1>
                ...
                <div class="flexslider effect2 effect2-contact tm-contact-box-1">
                    <ul class="slides">
                        <li>
                            ...
                            <div class="col-sm-12 ">
                                <div class="col-sm-3">
                                    <label  for="txt_usernm">User Name</label>
                                </div>
                                <input type="hidden" name="mcount" id="mcount" />
                                <div class="col-sm-3">
                                    <select name="user_name" id="user_name" onchange="select_permission();"  class="form-control text_purchase3" >
                                        <option value=""></option>
                                        <?php
