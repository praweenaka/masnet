                ...
                <ul class="slides">
                    <li>
                        <div class="tm-banner-inner">
                            <h1 class="tm-banner-title">SECU<span class="tm-yellow-text">RITY</span> </h1>
                    ...
                    <ul class="slides1">
                        <li>
                            ...
                            <div class="form-group">
                                ...
                                $sql = "select * from user_mast where user_name='" . $_SESSION['UserName'] . "' and user_depart='Security'";
                                ...
                                <?php
                                include './connectioni.php';
                                $sql = "select * from user_mast where user_name='" . $_SESSION['UserName'] . "' and (user_depart='Canteen' or user_depart='Transport' or user_depart='Jenetorial')";
                                $result = mysqli_query($GLOBALS['dbinv'], $sql);
